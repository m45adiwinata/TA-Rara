...
print('Selamat! Akurasi sistem anda NB : %f' % metrics.accuracy_score(pred, label_testing))
exec_time = time.time() - starttime
seconds = exec_time % 60
minutes = exec_time // 60
hours = minutes // 60
minutes = minutes % 60
print("Total execution time NB : %d hours %d minutes %d seconds." % (hours, minutes, seconds))
